...
class ModelsController extends Controller{
    ...
    public function store(Request $request){
        ...
        $model = array(
            ...
            'food_prefer' => $request->input('food_prefer'),
       ...
       $video = $request->videos;
        ...
        if ($video) {
            foreach ($video as $videos) {
                ...
                $videos->move('images/models',$videoName);
                $videosArr[] =$videoName;
            }
        ...
        if ($image) {
            foreach ($image as $images) {
                ...
                $images->move('images/models',$imageName);
                $imagesArr[] =$imageName;
            }
        }
